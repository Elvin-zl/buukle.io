...
public class GitTest {
    ...
    public void execute_test() throws Exception {
        MockHttpServletRequestBuilder builder = post("/rpc/genArchetype");

        CommonRequest<ArchetypesExecuteUpdateRPCDTO> commonRequest = new CommonRequest();

        Head head = Head.Builder.build();
        ArchetypesExecuteUpdateRPCDTO archetypesExecuteUpdateDTO = new ArchetypesExecuteUpdateRPCDTO();
        ...
        archetypesExecuteUpdateDTO.setArchetypesId(5);
        archetypesExecuteUpdateDTO.setGroupId("top.buukle");
        archetypesExecuteUpdateDTO.setVersion("1.0.0");
        archetypesExecuteUpdateDTO.setBasePackage("top.buukle");
        archetypesExecuteUpdateDTO.setArtifactId("xfd");

        archetypesExecuteUpdateDTO.setGitLocation("http://gitea.buukle.top/mall/xfd.git");
        archetypesExecuteUpdateDTO.setGitBranch("main");
        String s = JsonUtil.toJSONString(commonRequest);

        log.info("execute Mock入参:{}",s);
        builder.content(s);
        String userInfo = "{\"username\":\"zhanglei001\",\"expire\":\"36000\",\"userId\":\"bk_2a4cb611b112481ba2c52afccc8a0eaf\",\"mainTenant\":\"30\"}";
